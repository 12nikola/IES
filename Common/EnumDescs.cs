...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
            ...
            property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VAL1MULTIPLIER, typeof(UnitMultiplier));
            property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VAL1UNIT, typeof(UnitSymbol));
            property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VAL2MULTIPLIER, typeof(UnitMultiplier));
